  ...
  return (
    <section className="bg-white py-[var(--section-gap-y)]">
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <Reveal
          delay={0.1}
          className="mt-[var(--section-header-gap)] rounded-3xl border border-neutral-100 bg-white p-8 shadow-[0_8px_30px_rgba(3,66,142,0.09),0_6px_0_-2px_#03428E] sm:p-12 lg:p-16"
        >
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[2fr_3fr] lg:gap-12">
            ...
            <div className="relative border-l-[5px] border-[#6AA84F] pl-7">
              <blockquote className="space-y-5 text-lg font-medium italic leading-relaxed text-neutral-900">

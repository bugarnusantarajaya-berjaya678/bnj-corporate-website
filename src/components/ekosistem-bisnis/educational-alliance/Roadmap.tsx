...
const roadmap = [
  {
    ...
    year: "2026",
    description:
      "Kemitraan pendidikan aktif bersama SKN melalui ECA Aspire di Sampoerna Academy dan sekolah internasional lainnya.",
    active: true,
  },
  {
    ...
    year: "2027-2028",
    description:
      "Ekspansi ke jaringan expert multi-disiplin dan kemitraan sertifikasi profesional. Sampoerna Academy menargetkan 30 program ECA.",
    active: false,
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <Reveal className="mt-16">
          ...
          <h2 className="mt-4 max-w-2xl text-[26px] font-bold leading-[1.2] tracking-tight text-neutral-900 md:text-[36px]">
            Roadmap Strategic Educational Alliance
          </h2>

...
import heroImage from "../../../../public/images/Page-BNJ-Investment/EFM-invest-hero-section.png";
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#03428E] [clip-path:polygon(0_0,100%_0,100%_88%,0_100%)] sm:[clip-path:polygon(0_0,100%_0,100%_85%,0_100%)] lg:[clip-path:polygon(0_0,100%_0,100%_82%,0_100%)]">
      <div className="absolute inset-0 -z-10">
        <Image
          src={heroImage}
          alt="Ilustrasi investasi & ekspansi bisnis wellness/olahraga"
          fill
          priority
          sizes="100vw"
      ...
      <p className="pointer-events-none absolute bottom-5 right-6 z-[2] m-0 hidden text-xs italic text-white/75 sm:block lg:right-12">
        Ilustrasi investasi &amp; ekspansi bisnis wellness/olahraga
      </p>
      ...
      <div className="relative z-[2] mx-auto flex min-h-[clamp(560px,72vh,760px)] max-w-7xl items-center px-6 pb-24 pt-20 sm:pb-32 sm:pt-24 lg:px-12 lg:pb-40 lg:pt-28">
        <Reveal className="max-w-xl">
          ...
          <h1 className="text-[32px] font-bold leading-[1.2] text-white md:text-[48px]">
            Menyiapkan Jalur Investasi di Sektor Wellness, Fitness, Sport &amp; Health
          </h1>
          <p className="mt-5 max-w-lg text-base leading-relaxed text-white/85">
            BNJ Investment Ventures adalah unit bisnis BNJ yang direncanakan
            mulai beroperasi 2028, dengan fokus alokasi modal ke sektor
            Wellness, Fitness, Sport &amp; Health. Unit ini menjadi tahap
            lanjutan dari perjalanan BNJ membangun ekosistem bisnis yang
            berkelanjutan.
          </p>

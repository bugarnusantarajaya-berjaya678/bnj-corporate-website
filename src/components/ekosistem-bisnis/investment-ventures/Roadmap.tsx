...
const roadmap = [
  {
    ...
    year: "2028",
    description:
      "BNJ mulai berinvestasi langsung ke portofolio Wellness, Fitness, Sport & Health.",
    active: false,
  },
  {
    status: "Rencana Lanjutan",
    year: "2029-2030",
    description:
      "Membuka jalur investasi eksternal untuk ekspansi dan diversifikasi portofolio.",
    active: false,
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <Reveal className="mt-16">
          ...
          <h2 className="mt-4 max-w-2xl text-[26px] font-bold leading-[1.2] tracking-tight text-neutral-900 md:text-[36px]">
            Roadmap BNJ Investment Ventures
          </h2>

          <div className="relative mt-12 max-w-2xl">
            <div className="absolute left-[9px] right-[9px] top-[9px] h-[3px] bg-[#E3E7EC]" />
